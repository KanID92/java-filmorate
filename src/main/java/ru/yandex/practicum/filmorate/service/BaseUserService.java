...
public class BaseUserService implements UserService {
    ...
    public Collection<User> getFriendsById(long userId) {
        ...
        // Collection<Long> friendsIds = friendRepository.getFriendsIds(userId);

        // Set<User> friends = ;

//        User user = userRepository.getById(userId)
//                .orElseThrow(() -> new NotFoundException("Пользователь с данным id = "+ userId + " не найден"));
//        Set<Long> userFriendsIds;
//        if (isConfirmed) {
//            userFriendsIds = user.getConfirmedFriends();
//        } else {
//            userFriendsIds = user.getUnconfirmedFriends();
//        }
//
//        Set<User> userFriends = new HashSet<>();
//
//        for (Long userFriendId : userFriendsIds) {
//            Optional<User> userOpt = userRepository.getById(userFriendId);
//            userOpt.ifPresent(userFriends::add);
//        }
//        return userFriends;
    }
